...
classForm.addEventListener('submit', async (e) => {
    ...
    {
    document.getElementById('alertContainer').innerHTML = '<div style=" margin: 0 auto;"> <div class="alert error">  <input type="checkbox" id="alert1"/> <label class="close" title="close" for="alert1"> <i class="icon-remove"></i>  </label>  <p class="inner">اسم الفصل يجب ان يتكون من حروف فقط</p> </div>';
    setTimeout(() => {
     ...
     querySnapshotc.forEach(async(doc) =>{
       ...
       await addDoc(colRefSubject, {
        ...
        console.log("added")
            ...
            $('.loader').hide();
document.getElementById('alertContainer').innerHTML = '<div style=" margin: 0 auto;"> <div class="alert success">  <input type="checkbox" id="alert2"/> <label class="close" title="close" for="alert2"> <i class="icon-remove"></i>  </label>  <p class="inner"> تمت إضافة الفصل بنجاح</p> </div>';
setTimeout(() => {
  ...
  document.getElementById('alertContainer').innerHTML = '<span style="color: rgb(157, 48, 48);" class="req">جميع الحقول مطلوبة*</span>';
        ...
        $(".loader").hide();
       document.getElementById('alertContainer').innerHTML = '<div style=" margin: 0 auto;"> <div class="alert error">  <input type="checkbox" id="alert1"/> <label class="close" title="close" for="alert1"> <i class="icon-remove"></i>  </label>  <p class="inner">لم تتم الإضافة، يوجد فصل مُطابِق لاسم الفصل والمستوى</p> </div>';
       setTimeout(() => {
