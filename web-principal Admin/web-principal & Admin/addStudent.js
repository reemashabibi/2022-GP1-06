...
addStudentForm.addEventListener('submit', async (e) => {
  ...
  if (fname.value == "") {
    ...
    document.getElementById('alertContainer').innerHTML = '<div  style=" margin: 0 auto;"> <div class="alert error">  <input type="checkbox" id="alert1"/> <label class="close" title="close" for="alert1"> <i class="icon-remove"></i>  </label>  <p class="inner">يجب أن لا يكون  الاسم الأول للطالب فارغًا</p> </div>';
    setTimeout(() => {
  ...
  if (Lname.value == "") {
    document.getElementById('alertContainer').innerHTML = '<div  style=" margin: 0 auto;"> <div class="alert error">  <input type="checkbox" id="alert1"/> <label class="close" title="close" for="alert1"> <i class="icon-remove"></i>  </label>  <p class="inner">يجب أن لا يكون  الاسم الأخير للطالب فارغًا</p> </div>';
    setTimeout(() => {
  ...
  if (selectedClassIn == "non") {
    ...
    document.getElementById('alertContainer').innerHTML = '<div  style=" margin: 0 auto;"> <div class="alert error">  <input type="checkbox" id="alert1"/> <label class="close" title="close" for="alert1"> <i class="icon-remove"></i>  </label>  <p class="inner">يرجى اختيار الفصل</p> </div>';
    setTimeout(() => {
  ...
  if ((!phoneNo.value.match(phoneno))) {
    document.getElementById('alertContainer').innerHTML = '<div  style=" margin: 0 auto;"> <div class="alert error">  <input type="checkbox" id="alert1"/> <label class="close" title="close" for="alert1"> <i class="icon-remove"></i>  </label>  <p class="inner"> يلزم ان يتكون رقم الهاتف ١٠ ارقام باللغة الإنجليزية</p> </div>';
    setTimeout(() => {
  ...
  if (FnameParent.value == "") {
    document.getElementById('alertContainer').innerHTML = '<div style="  margin: 0 auto;"> <div class="alert error">  <input type="checkbox" id="alert1"/> <label class="close" title="close" for="alert1"> <i class="icon-remove"></i>  </label>  <p class="inner">يجب أن لا يكون الاسم الأول لولي الأمر فارغًا</p> </div>';
    setTimeout(() => {
  ...
  if (LnameParent.value == "") {
    document.getElementById('alertContainer').innerHTML = '<div style="  margin: 0 auto;"> <div class="alert error">  <input type="checkbox" id="alert1"/> <label class="close" title="close" for="alert1"> <i class="icon-remove"></i>  </label>  <p class="inner">يجب أن لا يكون الاسم الأخير لولي الأمر فارغًا</p> </div>';
    setTimeout(() => {
  ...
  if (!emailP.value.match(mailformat)) {
    document.getElementById('alertContainer').innerHTML = '<div style="  margin: 0 auto;"> <div class="alert error">  <input type="checkbox" id="alert1"/> <label class="close" title="close" for="alert1"> <i class="icon-remove"></i>  </label>  <p class="inner">الرجاء إدحال بريد إلكتروني صحيح</p> </div>';
    setTimeout(() => {
           ...
           async function (data, stat) {
            ...
            await  setDoc(doc(db, "School", schoolID, "Parent", data.uid), {
              ...
              await  addDoc(colRefStudent, {
                  ...
                  picked:'',
                  CommissionerId: [],
                  viewedLastAbsence: true,
                  viewedLastDocument: true
              ...
              document.getElementById('alertContainer').innerHTML = '<div style="  margin: 0 auto;"> <div class="alert error">  <input type="checkbox" id="alert1"/> <label class="close" title="close" for="alert1"> <i class="icon-remove"></i>  </label>  <p class="inner"> حصل خطأ بالنظام، الرجاء المحاولة لاحقًا</p> </div>';
              setTimeout(() => {
            ...
            snapshot.forEach(async (docu) => {
              ...
              await  addDoc(colRefStudent, {
                  ...
                  .then(d => {
                    ...
                    $(".loader").hide();
                    document.getElementById('alertContainer').innerHTML  = '<div style="  margin: 0 auto;"> <div class="alert success" id="alert-temp">  <input type="checkbox" id="alert2"/> <label class="close" title="close" for="alert2"> <i class="icon-remove"></i>  </label>  <p class="inner"> تمت الإضافة بنجاح</p> </div>';
                    setTimeout(() => {
                ...
                document.getElementById('alertContainer').innerHTML = '<div style=" margin: 0 auto;"> <div class="alert error">  <input type="checkbox" id="alert1"/> <label class="close" title="close" for="alert1"> <i class="icon-remove"></i>  </label>  <p class="inner"> الطالب مسجل بالنظام</p> </div>';
                setTimeout(() => {
