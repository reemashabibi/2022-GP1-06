...
var collection = FirebaseFirestore.instance.collection('School/'+ schoolID +'/Teacher');
collection.doc(user!.uid).snapshots().listen((docSnapshot) {
  ...
  String? OH;
  String Pass = "********";
  String NewFname =""; ///come backkkkkkkkkkkkkkkkkkkkkkkkkkkkk
  String NewLname ="";
  String NewEmail ="";
  String NewPass ="";
  String NewOH = "";
...
///check if any data has changed or not.
   checkChanges() {
     return ((FirstName!=FNameController.text && FNameController.text.isNotEmpty) || 
...
//////////////////////// Inputs /////////////////////////
           ...
           GestureDetector(
              onTap: () {
               ...
               // showAlertDialog(context);
                method(emailController.text, passwordController.text, FNameController.text, lNameController.text , officeHoursController.text);
              },
              child: Container(
  ...
  Future <void> GetInfo() async {
    User? user = FirebaseAuth.instance.currentUser;
     var col = await FirebaseFirestore.instance.collectionGroup('Teacher').where('Email', isEqualTo: user!.email);
...
Get();
 ...
 Future<void> method( String email, String pass, String fNm , String lN , String OH) async {
