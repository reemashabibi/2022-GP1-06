...
class Chatdetail extends StatefulWidget {
  ...
  @override
  Chatdetail({Key? key, required this.friendUid, required this.friendName, required this.schoolId, required this.classId, required this.subjectId, required this.msgCount}) : super (key:key);
  ...
  void sendMessage(String msg) {
    ...
    //  print(chatDocID.id);
      chats.doc(chatDocID).collection('messages').add({
        ...
        DocumentSnapshot dc = await FirebaseFirestore.instance.collection('School/${widget.schoolId}/Class').doc(widget.classId).collection("Subject").doc(widget.subjectId).get();
